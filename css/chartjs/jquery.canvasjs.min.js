...
(function () {
    ...
    function S(m) {
        var q = ((m & 16711680) >> 16).toString(16), s = ((m & 65280) >> 8).toString(16);
    ...
    function bb(m, q) {
        ...
        for (0 > v && (v += s); v < s; v++) if (v in this && this[v] === m) return v;
        return -1
    }
    ...
    function G(m, q) {
        ...
        if (s = {
            ...
            }[m || "solid"]) for (var v = 0; v < s.length; v++) s[v] *= q; else s = [];
        return s
    }
    ...
    function Xa(m, q, s) {
        ...
        q =
            !0;
        for (s = 0; 4 > s; s++) if (m[s] !== m[s + 4] | m[s] !== m[s + 8] | m[s] !== m[s + 12]) {
            q = !1;
            break
        }
    ...
    var $ = {}, v = !!document.createElement("canvas").getContext, ra = {
            Chart: {
                width: 500,
                height: 400,
                zoomEnabled: !1,
        ...
        }, Ka = {en: {}}, x = v ? "Trebuchet MS, Helvetica, sans-serif" : "Arial",
        Fa = v ? "Impact, Charcoal, sans-serif" : "Arial", Aa = {
    ...
    Fa = {
        ...
        title: {fontFamily: Fa, fontSize: 32, fontColor: fa, fontWeight: "normal", verticalAlign: "top", margin: 5},
        subtitles: [{
            fontFamily: Fa,
            fontSize: z,
            fontColor: fa,
    ...
    var Wa = {}, qa = null, Ba = function () {
            ...
            return function (R, C, Q) {
                ...
                Q = V ? "getUTC" : "get";
                var $ = R[Q + "Date"](), W = R[Q + "Day"](), Y = R[Q + "Month"](), U = R[Q + "FullYear"](),
                    I = R[Q + "Hours"](), X = R[Q + "Minutes"](), a = R[Q + "Seconds"](), f = R[Q + "Milliseconds"](),
            ...
            q = String(q);
            var z = 1, R = s = "", C = -1, Q = [], G = [], P = 0, S = 0, V = 0, O = !1, $ = 0,
                R = q.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
            q = null;
            for (var W = 0; R && W < R.length; W++) if (q = R[W], "." === q && 0 > C) C = W; else {
            ...
            m = (q[1] + "").split("");
            z && "0" === z[0] && z.shift();
            for (O = R = W = S = C = 0; 0 < Q.length;) if (q = Q.pop(), "#" === q || "0" === q) if (C++, C === P) {
                var Y = z, z = [];
                if ("0" === q) for (q = P - S - (Y ? Y.length : 0); 0 < q;) Y.unshift("0"), q--;
                for (; 0 < Y.length;) s = Y.pop() + s, O++, 0 === O % R && (W === V && 0 < Y.length) &&
                (s = x + s)
            } else 0 < z.length ? (s = z.pop() + s, S++, O++) : "0" === q && (s = "0" + s, S++, O++), 0 === O % R && (W === V && 0 < z.length) && (s = x + s); else "E" !== q[0] && "e" !== q[0] || "0" !== q[q.length - 1] || !/[eE][+-]*[0]+/.test(q) ? "," === q ? (W++, R = O, O = 0, 0 < z.length && (s = x + s)) : s = 1 < q.length && ('"' === q[0] && '"' === q[q.length - 1] || "'" === q[0] && "'" === q[q.length - 1]) ? q.slice(1, q.length - 1) + s : q + s : (q = 0 > $ ? q.replace("+", "").replace("-", "") : q.replace("-", ""), s += q.replace(/[0]+/, function (m) {
                return ha($, m.length)
            }));
            x = "";
            ...
            return {x: q, y: s}
        }, Ya = !0, Ra = window.devicePixelRatio || 1, Ma = 1, ga = Ya ? Ra / Ma : 1, ja = function (m) {
            for (var q = "", s = 0; s < m.length; s++) q += String.fromCharCode(Math.ceil(m.length / 57 / 5) ^ m.charCodeAt(s));
            return q
        },
    ...
    Y.prototype.removeEventListener = function (m, q) {
        if (m && q && this._eventListeners[m]) for (var v = this._eventListeners[m], y = 0; y < v.length; y++) if (v[y].eventHandler === q) {
            v[y].splice(y, 1);
            break
        }
    };
    ...
    Ia.prototype.render = function () {
        if (this.text) {
            var m = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, v = m.layoutManager.getFreeSpace(),
                s = v.x1, x = v.y1, z = 0, G = 0,
                S = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, R, C;
    ...
    La.Chart = function () {
        ...
        function s(a, f) {
            ...
            if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
                ...
                (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ca(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Ca(this._preRenderCtx), v ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ua(c, e), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")),
                    ...
                    "MSPointerCancel" : "touchcancel", function (a) {
                    b._touchEventHandler(a)
        ...
        function C(a, f, b, c, e, g) {
            ...
            this.stripLines = [];
            if (this.options.stripLines && 0 < this.options.stripLines.length) for (a = 0; a < this.options.stripLines.length; a++) this.stripLines.push(new fa(this.chart,
        ...
        s.prototype.render = function (a) {
            ...
            if (this.options.subtitles) for (this.subtitles = [], a = 0; a < this.options.subtitles.length; a++) b = new Oa(this, this.options.subtitles[a], a), this.subtitles.push(b), b.dockInsidePlotArea ? f.push(b) : b.render();
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var f =
                    ...
                    for (n = 0; n < p.dataPoints.length; n++) {
                        ...
                        p.dataPoints[n].x.getTime ? (g =
                            !0, c = p.dataPoints[n].x.getTime()) : c = p.dataPoints[n].x;
        ...
        s.prototype._processStacked100PlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var f = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, h = !1, l = !1, t = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                    var r =
                        this.data[a.dataSeriesIndexes[k]], p = 0, n = !1, d = !1, w;
        ...
        s.prototype.calculateAutoBreaks = function () {
            ...
            function f(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (c || b) for (var f = a.axisY.dataInfo, g = a.axisX.dataInfo, k, h = g.min, n = g.max, l = f.min, t = f.max, g = g._dataRanges, f = f._dataRanges, p, r = 0, m = 0; m < a.dataSeriesIndexes.length; m++) {
                        ...
                        if (!(4 > v.dataPoints.length)) for (r = 0; r < v.dataPoints.length; r++) if (c && (p = (n + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, k = v.dataPoints[r].x.getTime ? v.dataPoints[r].x.getTime() : v.dataPoints[r].x, p = Math.floor((k - h) / p), k < g[p].min &&
            ...
            function b(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks &&
                    ...
                    if (!(4 > l.dataPoints.length)) for (h = 0; h < l.dataPoints.length; h++) k = (f + 1 - b) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, c = l.dataPoints[h].x.getTime ? l.dataPoints[h].x.getTime() : l.dataPoints[h].x, k = Math.floor((c - b) / k), c < g[k].min && (g[k].min = c), c > g[k].max && (g[k].max =
                        c)
                }
            }
        ...
        s.prototype.getDataPointAtXY = function (a, f, b) {
            ...
            a = null;
            f = !1;
            for (b = 0; b < c.length; b++) if ("line" === c[b].dataSeries.type || "stepLine" === c[b].dataSeries.type || "area" === c[b].dataSeries.type || "stepArea" === c[b].dataSeries.type) if (e = ma("markerSize", c[b].dataPoint, c[b].dataSeries) ||
                    8, c[b].distance <= e / 2) {
                f = !0;
                break
            }
        ...
        s.prototype.renderIndexLabels = function (a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                var h = ma("indexLabelFontWeight", k.dataPoint, k.dataSeries),
                    ...
                    u = {percent: null, total: null}, T = null;
                ...
                if (null !== H && "" !== H) {
                    var u = ma("indexLabelPlacement", k.dataPoint, k.dataSeries),
                        T = ma("indexLabelOrientation", k.dataPoint, k.dataSeries), q = k.direction,
            ...
            function (a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var g = [], h, l = 0; l < a.dataSeriesIndexes.length; l++) {
                        ...
                        if (b.setLineDash) {
                            var n = G(k.nullDataLineDashType, k.lineThickness), p = k.lineDashType,
                ...
                for (var g = [], h, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (b.setLineDash) {
                        var n = G(k.nullDataLineDashType, k.lineThickness),
                            p = k.lineDashType, d = G(p, k.lineThickness);
                        b.setLineDash(d)
                    }
                    var w = k.id;
                    this._eventManager.objectMap[w] = {objectType: "dataSeries", dataSeriesIndex: t};
        ...
        s.prototype.renderSpline = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h = [], l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    var D = 0, u, T, H = [];
                    c.beginPath();
                    if (0 < r.length) for (T = !1, D = 0; D < r.length; D++) if (u = r[D].getTime ? r[D].x.getTime() : r[D].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !T))) if ("number" !== typeof r[D].y) 0 < D && !T && (k.connectNullData ? c.setLineDash && (0 < H.length && (k.options.nullDataLineDashType || !r[D - 1].lineDashType)) && (H[H.length -
        ...
        s.prototype.renderColumn = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < w.length) for (var m = 5 < p && d.bevelEnabled ? !0 : !1, g = 0; g < w.length; g++) if (w[g].getTime ?
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++) if (c = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                            ...
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) l[c] = u[k].y + (l[c] ? l[c] : 0), 0 < l[c] && (p = a.axisY.convertValueToPixel(l[c]),
                                y = "undefined" !== typeof g[c] ? g[c] : n, g[c] = p); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) t[c] = u[k].y + (t[c] ? t[c] : 0), y = a.axisY.convertValueToPixel(t[c]), p = "undefined" !== typeof h[c] ? h[c] : n, h[c] = y; else if (p = a.axisY.convertValueToPixel(u[k].y), 0 <= u[k].y) {
        ...
        s.prototype.renderStackedColumn100 = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var w = 0; w < a.dataSeriesIndexes.length; w++) {
                    ...
                    if (0 < u.length) for (var s = 5 < d && D.bevelEnabled ?
                        ...
                        (u[k].indexLabel || D.indexLabel || u[k].indexLabelFormatter || D.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1,
                            bounds: {x1: q, y1: Math.min(p, B), x2: y, y2: Math.max(p, B)},
                            color: c
                        })
                    }
                }
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++) if (c = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                            ...
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks &&
                                0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) l[c] = u[k].y + (l[c] ? l[c] : 0), 0 < l[c] && (B = g[c] ? g[c] : n, g[c] = r = a.axisY.convertValueToPixel(l[c])); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) t[c] = u[k].y + (t[c] ? t[c] : 0), r = h[c] ? h[c] : n, h[c] = B = a.axisY.convertValueToPixel(t[c]); else if (r = a.axisY.convertValueToPixel(u[k].y), 0 <= u[k].y) {
                                var A = g[c] ? g[c] : 0;
                                B = n + A;
                                r += A;
                                g[c] = A + (r - B)
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < m.length) {
                        ...
                        for (var da = !0; D < m.length; D++) if (q = m[D].x.getTime ? m[D].x.getTime() : m[D].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!w.connectNullData || !da))) if ("number" !== typeof m[D].y) w.connectNullData || (da || f) || c(), da = !0; else {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                    var r = a.dataSeriesIndexes[k],
                        p = this.data[r], n = p.dataPoints, l = p.id;
                    ...
                    if (0 < n.length) {
                        ...
                        var z = "solid";
                        if (c.setLineDash) {
                            var M = G(p.nullDataLineDashType, p.lineThickness), z = p.lineDashType,
        ...
        s.prototype.renderStepArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var h = this._eventManager.ghostCtx,
                    l = a.axisX.lineCoordinates, t = a.axisY.lineCoordinates, k = [], r = this.plotArea, p;
                g.save();
                v && h.save();
                g.beginPath();
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < m.length) {
                        ...
                        var J = "solid";
                        if (g.setLineDash) {
                            var ca = G(w.nullDataLineDashType, w.lineThickness), J = w.lineDashType,
        ...
        s.prototype.renderCandlestick = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e =
                        null, g = null, h = this.plotArea, l = 0, t, k, r, p, n, d,
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < q.length) for (var H = 5 < w && u.bevelEnabled ? !0 : !1, l = 0; l < q.length; l++) if (q[l].getTime ?
                        ...
                        var x = t - w / 2 << 0, B = x + w << 0,
                            ...
                            z = 0 === A % 2 ? 0 : 0.5, M = u.dataPointIds[l];
        ...
        s.prototype.renderBoxAndWhisker = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, g = this.plotArea, h = 0, l, t, k, r, p, n, d,
                    e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1,
                ...
                for (var m = !1, m = !!a.axisY.reversed, s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < H.length) for (var x = 5 < w && q.bevelEnabled ? !0 : !1, h = 0; h < H.length; h++) if (H[h].getTime ? d = H[h].x.getTime() : d = H[h].x, !(d < a.axisX.dataInfo.viewPortMin || d > a.axisX.dataInfo.viewPortMax) && !y(H[h].y) && H[h].y.length && "number" === typeof H[h].y[0] && "number" === typeof H[h].y[1] && "number" === typeof H[h].y[2] && "number" === typeof H[h].y[3] && "number" === typeof H[h].y[4] && 5 === H[h].y.length) {
                        ...
                        var B = l - w / 2 << 0, A = l + w / 2 << 0, e = H[h].color ? H[h].color : q._colorSet[0],
                            z = Math.round(Math.max(1, 0.15 * w)), M = 0 === z % 2 ? 0 : 0.5,
                            ...
                            E = 1 === Math.round(na) %
                            2 ? 0.5 : 0, C = H[h].stemDashType ? H[h].stemDashType : q.stemDashType,
                            ...
                            L = 1 === Math.round(P) % 2 ? 0.5 : 0, O = q.upperBoxColor, V = q.lowerBoxColor,
            ...
            function (a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                        ...
                        u < e && (u = e);
                        u > l && (u = l);
                        if (0 < B.length) for (var M = x._colorSet,
                                                   l = 0; l < B.length; l++) {
        ...
        s.prototype.renderRangeBar = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var c =
                        null, e = this.plotArea, g = 0, h, l, t, k,
                    g = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
                    ...
                    if (0 < w.length) {
                        ...
                        for (g = 0; g < w.length; g++) if (w[g].getTime ? k = w[g].x.getTime() : k = w[g].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !y(w[g].y) && w[g].y.length && "number" === typeof w[g].y[0] && "number" === typeof w[g].y[1]) {
                            ...
                            if (w[g].indexLabel || d.indexLabel || w[g].indexLabelFormatter || d.indexLabelFormatter) this._indexLabels.push({
                                ...
                                dataSeries: d,
                                indexKeyword: 1,
                                point: {x: w[g].y[1] >= w[g].y[0] ? l : h, y: t + (q - t) / 2},
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < p.length) {
                        ...
                        var A = "solid";
                        if (c.setLineDash) {
                            var z = G(r.nullDataLineDashType, r.lineThickness), A = r.lineDashType,
                                C = G(A, r.lineThickness);
                            c.setLineDash(C)
                        }
                        for (var K = !0; d < p.length; d++) if (u = p[d].x.getTime ? p[d].x.getTime() : p[d].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax &&
                            ...
                            n || K ? (r.connectNullData && !n ? (c.setLineDash && (r.options.nullDataLineDashType || A === r.lineDashType && r.lineDashType !== r.nullDataLineDashType) && (t[t.length - 1].newLineDashArray = C, A = r.nullDataLineDashType, c.setLineDash(z)), c.lineTo(w, m), v && e.lineTo(w, m), t.push({
                                ...
                                c.moveTo(w, m), s = {x: w, y: m}, t = [], t.push({
                                x: w,
                                y: q
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < r.length) {
                        ...
                        for (d = !1; p < r.length; p++) if (n = r[p].x.getTime ? r[p].x.getTime() : r[p].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
        ...
        s.prototype.renderWaterfall = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var d = 0; d < a.dataSeriesIndexes.length; d++) {
                    ...
                    if (0 < q.length) for (var y = 5 < n && m.bevelEnabled ? !0 : !1, x = !1, B = null, A = null, h = 0; h < q.length; h++) if (q[h].getTime ? r = q[h].x.getTime() : r = q[h].x, "number" !==
                        typeof q[h].y) {
                ...
                function h() {
                    ...
                    for (var b = a = 0, f = 0, h = !0, b = 0; 10 > b && (1 > b || 0 < f); b++) {
                        ...
                        var L = function (a, b, c) {
                            ...
                            for (b = 0; b < e.length; b++) if (c = e[b], f < 0.7 * a) f += c.indexLabelTextBlock.height, c.indexLabelTextBlock.text =
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    if (0 !== z) {
                        ...
                        this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function (a) {
                            ...
                            for (b = 0; b < r.length; b++) {
                                var c = 0 === b ? d[b].startAngle : e, e = c + (d[b].endAngle - d[b].startAngle),
                                    f = !1;
                                e > a && (e = a, f = !0);
        ...
        s.prototype.renderFunnel =
            function (a) {
                ...
                function e() {
                    ...
                    if (e) for (h = F.length - 1; 0 <= h; h--) a = N[h], F[h].textBlock.maxWidth = f[f.length - (h + 1)], F[h].textBlock.measureText(), F[h].textBlock.x = Q - g, c = F[h].textBlock.height < F[h].textBlock.maxHeight ? F[h].textBlock.height :
                ...
                function h() {
                    ...
                    function b() {
                        ...
                        for (k = N.length - 1; 0 < k; k--) if (!F[k].isDirty) {
                            e = p(k);
                    ...
                    function c(a, b, d) {
                        ...
                        for (d = 0; d < e.length; d++) if (b = e[d], f < a) g++, f += F[b.id].height + ga, F[b.id].textBlock.text = "", F[b.id].indexLabelText = "", F[b.id].isDirty = !0, F[b.id].textBlock.measureText(); else break;
                        return g
                    }
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    var J = z.x1 + B, Q = z.x2 - B, R = z.y1 + C, aa = z.y2 - C,
                    ...
                    if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
                        ...
                        var B = J + a / 2, Y = J, W = J + a, U = u.reversed ? aa : R, L = B - E / 2, Z = B + E / 2,
                            ba = u.reversed ? R + O : aa - O, sa = u.reversed ? R : aa;
                        a = [];
                        var B = [], N = [], M = [], X = R, fa, ea = (ba - U) / (L - Y), ha = -ea,
                            J = "area" === (u.valueRepresents ? u.valueRepresents : "height") ?
                                b() : f();
                        if (-1 !== J) {
                            if (u.reversed) for (M.push(X), E = J.length - 1; 0 < E; E--) X += J[E], M.push(X); else for (E = 0; E < J.length; E++) X += J[E], M.push(X);
                            if (u.reversed) for (E = 0; E < J.length; E++) M[E] < ba ? (a.push(L), B.push(Z), fa = E) : (a.push((M[E] - U + ea * Y) / ea), B.push((M[E] - U + ha * W) / ha)); else for (E = 0; E < J.length; E++) M[E] < ba ? (a.push((M[E] - U + ea * Y) / ea), B.push((M[E] - U + ha * W) / ha), fa = E) : (a.push(L), B.push(Z));
                            ...
                            return {
                                ...
                                }, easingFunction: I.easing.easeInQuad, animationBase: 0
                            }
                        }
                    }
                }
        ...
        s.prototype.getPercentAndTotal = function (a, f) {
            ...
            if (0 <= a.type.indexOf("stacked")) c = 0, b = f.x.getTime ? f.x.getTime() :
                f.x, b in a.plotUnit.yTotals && (c = a.plotUnit.yTotals[b], e = isNaN(f.y) ? 0 : 100 * (f.y / c)); else if ("pie" === a.type || "doughnut" === a.type || "funnel" === a.type || "pyramid" === a.type) {
        ...
        U.prototype.render = function () {
            ...
            for (var r = [], p = 0; p < this.dataSeries.length; p++) {
                ...
                if (n.dataPoints && n.dataPoints.length) if ("pie" !== n.type && "doughnut" !==
                    ...
                    if (0 <= g && g < this.dataPoints.length) {
                        ...
                        if (n) {
                            switch (this.type) {
                                ...
                                case "splineArea":
                                case "scatter":
                                    var q = ma("markerSize", d, this) || 4, s = b ? 20 : q,
        ...
        C.setLayoutAndRender = function (a, f, b, c,
            ...
            if ("normal" === e) {
                for (var z = [], C = [], G = [], B = [], P = [], Q = [], S = [], R = []; 4 > s;) {
                    ...
                    if (b && 0 < b.length) for (G = [], d = N = 0; d < b.length; d++) G.push(Math.ceil(b[d] ?
                        b[d].createLabelsAndCalculateWidth() : 0)), N += G[d], L += b[d] ? b[d].margin : 0; else G.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                    S.push(G);
                    ...
                    P.push(z);
                    if (f && 0 < f.length) for (C = [], d = X = 0; d < f.length; d++) f[d] && (f[d].lineCoordinates = {}), f[d].lineCoordinates.width =
                    ...
                    if (f && 0 < f.length) for (d = 0; d < f.length; d++) f[d].lineCoordinates.x1 = Math.round(g.x1 + N + L), f[d].lineCoordinates.x2 =
                    ...
                    if (b && 0 < b.length) for (d = 0; d < b.length; d++) L = 10, b[d] && (h = Math.round(a[0] ? a[0].lineCoordinates.x1 : f[0].lineCoordinates.x1), L = b[d]._labels && 0 < b[d]._labels.length ?
                    ...
                    if (c && 0 < c.length) for (d = 0; d < c.length; d++) c[d] && (h = Math.round(a[0] ? a[0].lineCoordinates.x2 : f[0].lineCoordinates.x2), t = Math.round(h), L = c[d]._labels && 0 < c[d]._labels.length ? c[d]._labels[c[d]._labels.length - 1].textBlock.height / 2 : 0, l = Math.round(g.y1 + X + W < Math.max(L, 10) ? Math.max(L, 10) : g.y1 + X + W), L = 0 < a.length ? 0 : c[d]._labels && 0 < c[d]._labels.length ? c[d]._labels[0].textBlock.height / 2 : 0, k = Math.round(g.y2 - (Z + e + L)), c[d].lineCoordinates =
                        {x1: h + Y, y1: l, x2: h + Y, y2: k, height: Math.abs(k - l)}, c[d].bounds = {
                        x1: h,
                        y1: l,
                        x2: t + (B[d] + Y),
                        y2: k,
                    ...
                    if (0 < s) {
                        if (a && 0 < a.length) for (d = 0; d < a.length; d++) q = P[s - 1][d] === P[s][d] ? !0 : !1; else q =
                            !0;
                        if (f && 0 < f.length) for (d = 0; d < f.length; d++) K = Q[s - 1][d] === Q[s][d] ? !0 : !1; else K = !0;
                        if (b && 0 < b.length) for (d = 0; d < b.length; d++) J = S[s - 1][d] === S[s][d] ? !0 : !1; else J = !0;
                        if (c && 0 < c.length) for (d = 0; d < c.length; d++) O = R[s - 1][d] === R[s][d] ? !0 : !1; else O = !0
                    }
                    if (q && K && J && O) break;
                    s++
                }
                ...
                for (S = []; 4 > s;) {
                    ...
                    Q.push(x);
                    if (f && 0 < f.length) for (I = [], d = X = 0; d < f.length; d++) I.push(Math.ceil(f[d] ? f[d].createLabelsAndCalculateWidth() : 0)), X += I[d], W += f[d] ? f[d].margin : 0; else I.push(Math.ceil(f[0] ? f[0].createLabelsAndCalculateWidth() : 0));
                    S.push(I);
                    ...
                    if (b && 0 < b.length) for (A = [], d = Y = 0; d < b.length; d++) A.push(Math.ceil(b[d] ? b[d].createLabelsAndCalculateHeight() : 0)), Y += A[d] + b[d].margin, L += b[d].margin; else A.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                    u.push(A);
                    if (c && 0 < c.length) for (M = [], d = N = 0; d < c.length; d++) M.push(Math.ceil(c[d] ? c[d].createLabelsAndCalculateHeight() : 0)), N += M[d], $ += c[d].margin; else M.push(Math.ceil(c[0] ?
                    ...
                    if (c && 0 < c.length) for (d = c.length - 1; 0 <= d; d--) c[d] && (l = Math.round(g.y1), k = Math.round(g.y1 + (M[d] + c[d].margin + U)), c[d].lineCoordinates.y1 = k, c[d].lineCoordinates.y2 = k, c[d].bounds = {
                        x1: h,
                        y1: l + (c[d].margin + U),
                        x2: t,
                        y2: k,
                    ...
                    if (a && 0 < a.length) for (d = 0; d < a.length; d++) {
                        ...
                        if (b && 0 < b.length) for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && (t = 0 > b[L].labelAngle ?
                            Math.max(t, z) : 0 === b[L].labelAngle ? Math.max(t, z / 2) : t, h = 0 > b[L].labelAngle || 0 === b[L].labelAngle ? t - Z : h);
                        if (c && 0 < c.length) for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (t = c[L].lineCoordinates.x1, h = t - Z);
                    ...
                    if (f && 0 < f.length) for (d = 0; d < f.length; d++) {
                        ...
                        if (b && 0 < b.length) for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && (t = 0 > b[L].labelAngle ? Math.max(t, z) : 0 === b[L].labelAngle ? Math.max(t, z / 2) : t, h = 0 > b[L].labelAngle || 0 === b[L].labelAngle ? t - X : h);
                        if (c && 0 < c.length) for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (t = c[L].lineCoordinates.x2, h = t - X);
                    ...
                    for (d = 0; d < n.length; d++) "axisY" === n[d].type && (n[d].calculateValueToPixelConversionParameters(), n[d].calculateBreaksSizeInValues());
                    if (0 < s) {
                        if (a && 0 < a.length) for (d = 0; d < a.length; d++) q = Q[s - 1][d] === Q[s][d] ? !0 : !1; else q = !0;
                        if (f && 0 < f.length) for (d = 0; d < f.length; d++) K = S[s - 1][d] === S[s][d] ? !0 : !1; else K = !0;
                        if (b && 0 <
                            b.length) for (d = 0; d < b.length; d++) J = u[s - 1][d] === u[s][d] ? !0 : !1; else J = !0;
        ...
        C.prototype.calculateValueToPixelConversionParameters = function (a) {
            ...
            if (this.logarithmic) for (var e = 0; e < a.length && !(this.viewportMaximum < a[e].startValue); e++) this.viewportMinimum > a[e].endValue || (this.viewportMinimum >= a[e].startValue && this.viewportMaximum <= a[e].endValue ? b = 0 : this.viewportMinimum <= a[e].startValue && this.viewportMaximum >= a[e].endValue ? (c = c / a[e].endValue * a[e].startValue,
        ...
        C.prototype.calculateAxisParameters = function () {
            if (this.logarithmic) this.calculateLogarithmicAxisParameters(); else {
                ...
                if (y(this.options.viewportMinimum) && !y(this.sessionVariables.newViewportMinimum) &&
                    !isNaN(this.sessionVariables.newViewportMinimum)) this.viewportMinimum = this.sessionVariables.newViewportMinimum; else if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = this.minimum;
        ...
        ba.prototype.render = function (a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                var f =
                    this.ctx, b = this.ctx.globalAlpha;
                this.ctx = a || this.ctx;
                this.ctx.save();
                this.ctx.beginPath();
                this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position) if (c = 1 === p % 2 ? (c.x << 0) + 0.5 : c.x << 0, h = 1 === p % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, l = this.chart.plotArea.y2 + p / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, l = this.chart.plotArea.y1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = {
                        ...
                        e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(c, l), this.ctx.lineTo(h, l), this.ctx.lineTo(h, e); else if ("wavy" === this.type) {
                    m = c;
                    k = e;
                    g = 0.5;
                    r = (l - k) / a / 3;
        ...
        ha.prototype.render = function (a, f) {
            ...
            if (!this.valueFormatString) if ("dateTime" ===
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    var d = null;
                    if ("bottom" === this.parent._position || "top" === this.parent._position) n = this.parent.dataSeries[0].axisX.convertPixelToValue({y: f}); else if ("left" === this.parent._position || "right" === this.parent._position) n = this.parent.convertPixelToValue({y: f});
                    ...
                    q = 0;
                    if ("rangeBar" === h[0].dataSeries.type || "error" === h[0].dataSeries.type) for (var d = Math.abs(a - this.parent.convertValueToPixel(h[q].dataPoint.y[0])), s = 0, n = 0; n < h.length; n++) if (h[n].dataPoint.y && h[n].dataPoint.y.length) for (m = 0; m < h[n].dataPoint.y.length; m++) s = Math.abs(a - this.parent.convertValueToPixel(h[n].dataPoint.y[m])), s < d && (d = s, q = n); else s = Math.abs(a - this.parent.convertValueToPixel(h[n].dataPoint.y)),
                    s < d && (d = s, q = n); else if ("stackedBar" === h[0].dataSeries.type) for (var d = Math.abs(a - this.parent.convertValueToPixel(h[0].dataPoint.y)), v = s = 0, n = q = 0; n < h.length; n++) if (h[n].dataPoint.y && h[n].dataPoint.y.length) for (m = 0; m < h[n].dataPoint.y.length; m++) s = Math.abs(a - this.parent.convertValueToPixel(h[n].dataPoint.y[m])), s < d && (d = s, q = n); else v += h[n].dataPoint.y, s = Math.abs(a - this.parent.convertValueToPixel(v)), s < d && (d = s, q = n); else if ("stackedBar100" === h[0].dataSeries.type) for (var d = Math.abs(a - this.parent.convertValueToPixel(h[0].dataPoint.y)),
                        ...
                        h[n].dataPoint.y.length) for (m = 0; m < h[n].dataPoint.y.length; m++) s = Math.abs(a - this.parent.convertValueToPixel(h[n].dataPoint.y[m])), s < d && (d = s, q = n); else s = Math.abs(a - this.parent.convertValueToPixel(h[n].dataPoint.y)), s < d && (d = s, q = n);
                    m = h[q];
                    ...
                    if ("rangeColumn" === h[0].dataSeries.type || "rangeArea" === h[0].dataSeries.type || "error" === h[0].dataSeries.type || "rangeSplineArea" === h[0].dataSeries.type ||
                        ...
                        h[n].dataPoint.y.length) for (m = 0; m < h[n].dataPoint.y.length; m++) s = Math.abs(f - this.parent.convertValueToPixel(h[n].dataPoint.y[m])), s < d && (d = s, q = n); else s = Math.abs(f - this.parent.convertValueToPixel(h[n].dataPoint.y)), s < d && (d = s, q = n);
                    m = h[q];
                    b = 0;
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) if ("left" === this.parent._position || "right" === this.parent._position) {
                    u = !1;
                    if (this.parent.labels) for (h = Math.ceil(this.parent.interval), n = 0; n < this.parent.viewportMaximum; n +=
                        h) if (this.parent.labels[n]) u = !0; else {
                        u = !1;
                        break
                    }
                    if (u) {
